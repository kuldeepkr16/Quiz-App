...
public class StudentOptionsFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form LoggedInAsStudent
     */
    ...
    private void initComponents() {
        ...
        jrbChange = new javax.swing.JRadioButton();
        ...
        jrbTake.setBackground(new java.awt.Color(0, 0, 0));
        jrbTake.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jrbTake.setForeground(new java.awt.Color(255, 255, 255));
        jrbTake.setText("Take Test");

        jrbView.setBackground(new java.awt.Color(0, 0, 0));
        jrbView.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jrbView.setForeground(new java.awt.Color(255, 255, 255));
        jrbView.setText("View Score");

        jrbChange.setBackground(new java.awt.Color(0, 0, 0));
        jrbChange.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jrbChange.setForeground(new java.awt.Color(255, 255, 255));
        jrbChange.setText("Change Password");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("G:\\javaprojects\\SCA\\images.jpeg")); // NOI18N
    ...
    private void lblLogoutMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblLogoutMouseClicked
        ...
        private String getSelected(){
            if(jrbTake.isSelected())
                return jrbTake.getText();
            else if(jrbView.isSelected())
                return jrbView.getText();
            else if(jrbChange.isSelected())
                return jrbChange.getText();
            else
                return null;
        }
    private void btnDoTaskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoTaskActionPerformed
        ...
        else if(select == "Take Test")
            jf = new PaperSelectionFrame();
        else if(select == "View Score"){
            try{
                ArrayList<String> examId = PerformanceDAO.getAllExamID(UserProfile.getUsername());
                if(examId.isEmpty()){
                    JOptionPane.showMessageDialog(null,"you haven't given any exam","error",JOptionPane.ERROR_MESSAGE);
                    return;
                }
    ...
    private javax.swing.JRadioButton jrbChange;
